...
// func keyS3() string { return "dead:beef/_/1" }
...
func TestX(t *testing.T) {
	...
	// ddbtest.GetItem[dynamotest.Person],

}

// func TestS3GetSuccess(t *testing.T) {
// 	api := s3test.GetObject[person](keyS3(), valStruct())

// 	val, err := api.Get(keyStruct())
// 	it.Ok(t).
// 		If(err).Should().Equal(nil).
// 		If(val).Should().Equal(valStruct())
// }

// func TestS3GetFailure(t *testing.T) {
// 	api := s3test.GetObject[person]("none", valStruct())
...
// 	// TODO: testing using type-classes
